...
namespace {
struct qt_meta_tag_ZN15BookmarksDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto BookmarksDialog::qt_create_metaobjectdata<qt_meta_tag_ZN15BookmarksDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<BookmarksDialog, qt_meta_tag_ZN15BookmarksDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject BookmarksDialog::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BookmarksDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BookmarksDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15BookmarksDialogE_t>.metaTypes,
    nullptr
} };
...
void BookmarksDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->extract(); break;
        case 4: _t->activateItem((*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[1]))); break;
...
void *BookmarksDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BookmarksDialogE_t>.strings))

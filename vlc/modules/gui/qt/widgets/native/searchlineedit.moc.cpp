...
template <> constexpr inline auto SearchLineEdit::qt_create_metaobjectdata<qt_meta_tag_ZN14SearchLineEditE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SearchLineEdit, qt_meta_tag_ZN14SearchLineEditE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject SearchLineEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<QLineEdit::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14SearchLineEditE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14SearchLineEditE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14SearchLineEditE_t>.metaTypes,
    nullptr
} };
...
void SearchLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->searchDelayedChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SearchLineEdit::*)(const QString & )>(_a, &SearchLineEdit::searchDelayedChanged, 0))
            return;
    }
}
...
void *SearchLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14SearchLineEditE_t>.strings))
